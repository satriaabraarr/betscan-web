...
<section id="beranda">
    <div class="hero-container">
        ...
        <h1 class="hero-title">
            Detect <span class="highlight">Gambling Content</span><br>
            Using Machine Learning
        </h1>

        <p class="hero-sub">
            A <strong>Machine Learning</strong> based detection system to accurately detect gambling <br> content within seconds.
        </p>

        <div class="hero-actions">
            <a href="#mulai-deteksi" class="btn-primary">
                Start Detection
                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style="width:25px;height:25px">
        ...
        <div class="hero-stats">
            ...
            <div class="hero-stat">
                ...
                <div class="hero-stat-label">Training Data</div>
            </div>
            <div class="hero-stat">
