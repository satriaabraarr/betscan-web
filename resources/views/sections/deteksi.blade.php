<div class="img-lightbox-overlay" id="imgLightbox" onclick="closeLightbox(event)">
    <button class="img-lightbox-close" onclick="document.getElementById('imgLightbox').classList.remove('show'); document.body.style.overflow='';">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12"/>
        </svg>
    </button>
    <img src="" id="lightboxImg" alt="Hasil Deteksi Bounding Box" onclick="event.stopPropagation()">
</div>

<section id="mulai-deteksi" class="section">
    <div class="section-container">
        ...
        <div class="deteksi-header">
            ...
            <h2 class="section-title">Form <span class="accent-gradient">Detection &amp; Recommendation</span></h2>
            <p class="section-desc">
                Complete the information below and enter text or upload an image (or both) to receive accurate and comprehensive detection results.
            </p>
        </div>

        <div class="deteksi-form-wrap">
            <form id="detectionForm" enctype="multipart/form-data" onsubmit="return false;">
                @csrf
                @include('sections.deteksi.form-user')
                @include('sections.deteksi.form-input')
            ...
            @include('sections.deteksi.hasil-deteksi')
        </div>
